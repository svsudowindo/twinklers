...
/* harmony default export */ __webpack_exports__["default"] = ("<app-topbar>\r\n</app-topbar>\r\n<div>\r\n    <router-outlet></router-outlet>\r\n</div>");
...
const routes = [
    ...
    {
        path: 'dashboard',
        loadChildren: () => __webpack_require__.e(/*! import() | views-user-views-dashboard-dashboard-module */ "views-user-views-dashboard-dashboard-module").then(__webpack_require__.bind(null, /*! ./views/user-views/dashboard/dashboard.module */ "./src/app/views/user-views/dashboard/dashboard.module.ts")).then(m => m.DashboardModule)
    },
    {
        path: 'products',
        loadChildren: () => __webpack_require__.e(/*! import() | views-user-views-products-products-module */ "views-user-views-products-products-module").then(__webpack_require__.bind(null, /*! ./views/user-views/products/products.module */ "./src/app/views/user-views/products/products.module.ts")).then(m => m.ProductsModule)
    },
    {
        path: 'my-account/login',
        loadChildren: () => Promise.all(/*! import() | views-auth-views-login-login-module */[__webpack_require__.e("default~profile-profile-module~views-auth-views-login-login-module~views-auth-views-registration-reg~fbe267c6"), __webpack_require__.e("common"), __webpack_require__.e("views-auth-views-login-login-module")]).then(__webpack_require__.bind(null, /*! ./views/auth-views/login/login.module */ "./src/app/views/auth-views/login/login.module.ts")).then(m => m.LoginModule)
    },
    {
        path: 'my-account/registration',
        loadChildren: () => Promise.all(/*! import() | views-auth-views-registration-registration-module */[__webpack_require__.e("default~profile-profile-module~views-auth-views-login-login-module~views-auth-views-registration-reg~fbe267c6"), __webpack_require__.e("common"), __webpack_require__.e("views-auth-views-registration-registration-module")]).then(__webpack_require__.bind(null, /*! ./views/auth-views/registration/registration.module */ "./src/app/views/auth-views/registration/registration.module.ts")).then(m => m.RegistrationModule)
    },
    {
        path: 'my-account/forgot-password',
        loadChildren: () => Promise.all(/*! import() | views-auth-views-forgot-password-forgot-password-module */[__webpack_require__.e("common"), __webpack_require__.e("views-auth-views-forgot-password-forgot-password-module")]).then(__webpack_require__.bind(null, /*! ./views/auth-views/forgot-password/forgot-password.module */ "./src/app/views/auth-views/forgot-password/forgot-password.module.ts")).then(m => m.ForgotPasswordModule)
    },
    {
        path: 'admin',
        loadChildren: () => __webpack_require__.e(/*! import() | views-admin-views-admin-dashboard-admin-dashboard-module */ "views-admin-views-admin-dashboard-admin-dashboard-module").then(__webpack_require__.bind(null, /*! ./views/admin-views/admin-dashboard/admin-dashboard.module */ "./src/app/views/admin-views/admin-dashboard/admin-dashboard.module.ts")).then(m => m.AdminDashboardModule)
    },
    {
        path: 'my-account/user-management',
        loadChildren: () => __webpack_require__.e(/*! import() | views-user-views-user-management-user-management-module */ "views-user-views-user-management-user-management-module").then(__webpack_require__.bind(null, /*! ./views/user-views/user-management/user-management.module */ "./src/app/views/user-views/user-management/user-management.module.ts")).then(m => m.UserManagementModule)
    },
    {
        path: '**',
        loadChildren: () => __webpack_require__.e(/*! import() | views-page-not-found-page-not-found-module */ "views-page-not-found-page-not-found-module").then(__webpack_require__.bind(null, /*! ./views/page-not-found/page-not-found.module */ "./src/app/views/page-not-found/page-not-found.module.ts")).then(m => m.PageNotFoundModule)
    },
];
...
let AppComponent = class AppComponent {
    constructor(httpClient) {
        ...
        this.httpClient.get('https://www.universal-tutorial.com/api/getaccesstoken', { headers }).subscribe(res => {
            ...
            let authTokenHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _shared_shared_components_layouts_admin_layout_admin_layout_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shared/shared/components/layouts/admin-layout/admin-layout.component */ "./src/app/shared/shared/components/layouts/admin-layout/admin-layout.component.ts");
...
/* harmony import */ var _shared_shared_components_topbar_topbar_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./shared/shared/components/topbar/topbar.component */ "./src/app/shared/shared/components/topbar/topbar.component.ts");
/* harmony import */ var _shared_shared_components_layouts_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./shared/shared/components/layouts/auth-layout/auth-layout.component */ "./src/app/shared/shared/components/layouts/auth-layout/auth-layout.component.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _shared_services_http_header_interceptors_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./shared/services/http/header-interceptors.service */ "./src/app/shared/services/http/header-interceptors.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        declarations: [
            ...
            _shared_shared_components_topbar_topbar_component__WEBPACK_IMPORTED_MODULE_7__["TopbarComponent"],
            _shared_shared_components_layouts_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_8__["AuthLayoutComponent"],
            _shared_shared_components_layouts_admin_layout_admin_layout_component__WEBPACK_IMPORTED_MODULE_1__["AdminLayoutComponent"]
        ],
        imports: [
        ...
        providers: [
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HTTP_INTERCEPTORS"], useClass: _shared_services_http_header_interceptors_service__WEBPACK_IMPORTED_MODULE_10__["HeaderInterceptorsService"], multi: true }
        ],
...
/* harmony import */ var _pipes_highlight_search_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../pipes/highlight-search.pipe */ "./src/app/shared/pipes/highlight-search.pipe.ts");
/* harmony import */ var _shared_components_product_card_product_card_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../shared/components/product-card/product-card.component */ "./src/app/shared/shared/components/product-card/product-card.component.ts");
...
CustomModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _pipes_highlight_search_pipe__WEBPACK_IMPORTED_MODULE_3__["HighlightSearchPipe"],
            _shared_components_product_card_product_card_component__WEBPACK_IMPORTED_MODULE_4__["ProductCardComponent"]
        ],
        imports: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PredefinedModule", function() { return PredefinedModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let PredefinedModule = class PredefinedModule {
};
PredefinedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var _constants_local_storage_enums__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../constants/local-storage-enums */ "./src/app/shared/constants/local-storage-enums.ts");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ "./src/app/shared/services/common/utils.ts");
...
let CommonService = class CommonService {
    ...
    getUserInfo() {
        const userInfo = this.storageService.getLocalStorageItem(_constants_local_storage_enums__WEBPACK_IMPORTED_MODULE_2__["LOCAL_STORAGE_ENUMS"].USERINFO);
        if (userInfo) {
...
class Utils {
    ...
    //  }
    // }
    static getObjectFromArray(inputArray, key, id) {
    ...
    static convertArrayToCommaSeparatedString(pobjArray) {
        let outputText = '';
    ...
    static toIsoString(input) {
        // tslint:disable-next-line:one-variable-per-declaration
        const tzo = -input.getTimezoneOffset(), dif = tzo >= 0 ? '+' : '-', pad = (num) => {
    ...
    static getDateInCustomFormat(inputDateString) {
    ...
    static getTime(inputString) {
        try {
            const arr = inputString.split(/[- :]/);
            const inputDateFormat = new Date(parseInt(arr[0], 10), parseInt(arr[1], 10) - 1, parseInt(arr[2], 10), parseInt(arr[3], 10), parseInt(arr[4], 10), parseInt(arr[5], 10));
    ...
    static getTimeFromString(inputString) {
        try {
            const arr = inputString.split(' ');
    ...
    static convertStringToNumber(input, defaultValue) {
        if (Utils.isValidInput(input)) {
    ...
    static getObjectByFilter(arrayToFilter, key, id) {
        return arrayToFilter.filter(x => x[key] === id);
    }
    static getObjectByFind(arrayToFilter, key, id) {
    ...
    static convertNumberToBoolean(input) {
        if (Utils.isValidInput(input)) {
            if (input === 0) {
                return true;
            }
...
Utils.stringifyObjectWithNoQuotesOnKeys = (objFromJson) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HeaderInterceptorsService", function() { return HeaderInterceptorsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let HeaderInterceptorsService = class HeaderInterceptorsService {
...
HeaderInterceptorsService.ctorParameters = () => [
    { type: _common_common_service__WEBPACK_IMPORTED_MODULE_1__["CommonService"] }
];
HeaderInterceptorsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])()
], HeaderInterceptorsService);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EncryptDectryptService", function() { return EncryptDectryptService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var simple_crypto_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! simple-crypto-js */ "./node_modules/simple-crypto-js/build/SimpleCrypto.js");
/* harmony import */ var simple_crypto_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(simple_crypto_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../common/utils */ "./src/app/shared/services/common/utils.ts");




let EncryptDectryptService = class EncryptDectryptService {
    constructor() {
...
EncryptDectryptService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _encrypt_dectrypt_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./encrypt-dectrypt.service */ "./src/app/shared/services/storage/encrypt-dectrypt.service.ts");



let StorageService = class StorageService {
    constructor(encryptDectryptService) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _modules_custom_custom_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/custom/custom.module */ "./src/app/shared/modules/custom/custom.module.ts");
/* harmony import */ var _modules_predefined_predefined_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/predefined/predefined.module */ "./src/app/shared/modules/predefined/predefined.module.ts");
...
SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _modules_custom_custom_module__WEBPACK_IMPORTED_MODULE_3__["CustomModule"],
            _modules_predefined_predefined_module__WEBPACK_IMPORTED_MODULE_4__["PredefinedModule"]
        ],
        exports: [
            _modules_custom_custom_module__WEBPACK_IMPORTED_MODULE_3__["CustomModule"],
            _modules_predefined_predefined_module__WEBPACK_IMPORTED_MODULE_4__["PredefinedModule"]
...
AdminLayoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./admin-layout.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/shared/components/layouts/admin-layout/admin-layout.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./admin-layout.component.scss */ "./src/app/shared/shared/components/layouts/admin-layout/admin-layout.component.scss")).default]
    })
...
AuthLayoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./auth-layout.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/shared/components/layouts/auth-layout/auth-layout.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./auth-layout.component.scss */ "./src/app/shared/shared/components/layouts/auth-layout/auth-layout.component.scss")).default]
    })
], AuthLayoutComponent);
...
], ProductCardComponent.prototype, "addItem", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], ProductCardComponent.prototype, "removeItem", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], ProductCardComponent.prototype, "cardClickEvent", void 0);
ProductCardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-product-card',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./product-card.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/shared/components/product-card/product-card.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./product-card.component.scss */ "./src/app/shared/shared/components/product-card/product-card.component.scss")).default]
    })
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _services_common_common_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../services/common/common.service */ "./src/app/shared/services/common/common.service.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _topbar_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./topbar.service */ "./src/app/shared/shared/components/topbar/topbar.service.ts");
...
let TopbarComponent = class TopbarComponent {
    constructor(topbarService, router, commonService) {
...
TopbarComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-topbar',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./topbar.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/shared/components/topbar/topbar.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./topbar.component.scss */ "./src/app/shared/shared/components/topbar/topbar.component.scss")).default]
    })
], TopbarComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TopbarService", function() { return TopbarService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _services_common_common_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../services/common/common.service */ "./src/app/shared/services/common/common.service.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let TopbarService = class TopbarService {
    constructor(commonService) {
        this.commonService = commonService;
        this.cartCount = 0;
        this.cartCountSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](0);
        this.userInfoChanged = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](false);
        // sample
        this.products = [
            {
                name: 'Product 1',
    ...
    setUserInfoChange(input) {
        this.userInfoChanged.next(input);
    }
};
TopbarService.ctorParameters = () => [
    { type: _services_common_common_service__WEBPACK_IMPORTED_MODULE_1__["CommonService"] }
];
TopbarService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: 'root'
    })
], TopbarService);
...
module.exports = __webpack_require__(/*! D:\dream_startups\soruce_code\twinklers\src\main.ts */"./src/main.ts");
