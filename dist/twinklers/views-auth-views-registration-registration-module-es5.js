...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-auth-views-registration-registration-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppViewsAuthViewsRegistrationRegistrationComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewsAuthViewsRegistrationRegistrationRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    RegistrationRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
  ...
  /***/
  function srcAppViewsAuthViewsRegistrationRegistrationComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppViewsAuthViewsRegistrationRegistrationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_services_common_baseClass__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var src_app_shared_services_common_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var src_app_shared_constants_validation_patterns__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! src/app/shared/constants/validation-patterns */
    "./src/app/shared/constants/validation-patterns.ts");

    var RegistrationComponent =
    /*#__PURE__*/
    function (_shared_services_comm) {
      _inherits(RegistrationComponent, _shared_services_comm);

      function RegistrationComponent(injector, commonRequestService, formBuilder, router) {
        var _this;

        _classCallCheck(this, RegistrationComponent);

        _this = _possibleConstructorReturn(this, _getPrototypeOf(RegistrationComponent).call(this));
        _this.injector = injector;
        _this.commonRequestService = commonRequestService;
        _this.formBuilder = formBuilder;
        _this.router = router;
        _this.gendersList = [];
        _this.isTermsAndConditionsAccepted = false;
      ...
      _createClass(RegistrationComponent, [{
        ...
        value: function getGenders() {
          ...
          this.commonRequestService.request(_shared_constants_request_enums__WEBPACK_IMPORTED_MODULE_2__["RequestEnums"].GET_GENDER_LIST).subscribe(function (res) {
            console.log(res);
        ...
        value: function userRegister() {
          ...
          this.commonRequestService.request(_shared_constants_request_enums__WEBPACK_IMPORTED_MODULE_2__["RequestEnums"].REGISTER, this.registerForm.value).subscribe(function (res) {
            console.log(res);
            ...
            if (res.errors.length > 0) {
              ...
              _this3.router.navigate(['my-account', 'login']);
            }
          });
        }
      }]);
      ...
      return RegistrationComponent;
    }(_shared_services_common_baseClass__WEBPACK_IMPORTED_MODULE_4__["BaseClass"]);
    ...
    RegistrationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["Component"])({
      selector: 'app-registration',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./registration.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/views/auth-views/registration/registration.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./registration.component.scss */
      "./src/app/views/auth-views/registration/registration.component.scss")).default]
  ...
  /***/
  function srcAppViewsAuthViewsRegistrationRegistrationModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _registration_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    RegistrationModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_registration_component__WEBPACK_IMPORTED_MODULE_4__["RegistrationComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _registration_routing_module__WEBPACK_IMPORTED_MODULE_3__["RegistrationRoutingModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"]]
    })], RegistrationModule);
    /***/
  }
}]);
//# sourceMappingURL=views-auth-views-registration-registration-module-es5.js.map